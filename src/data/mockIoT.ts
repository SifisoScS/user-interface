...
export const defaultIoTState: IoTState = {
  lights: [
    ...
    { id: 'l4', name: 'Ceiling',     room: 'Bedroom',     on: false, brightness: 60, temperature: 'warm',    watts: 8  },
    { id: 'l5', name: 'Bedside',     room: 'Bedroom',     on: true,  brightness: 25, temperature: 'warm',    watts: 4  },
    ...
    { id: 'l8', name: 'Desk Lamp',   room: 'Office',      on: true,  brightness: 90, temperature: 'cool',    watts: 7  },
  ],
  thermostat: {
    currentTemp: 21,
    targetTemp: 22,
